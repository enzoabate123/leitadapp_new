        ...
        <div class="xp-window-body">
          <div class="admin-content-layout">
            ...
            <main class="xp-main-panel">
              ...
              <!-- ===== TAB 6: GERENCIADOR DE MÚSICAS ===== -->
              <div v-else-if="activeTab === 'music'" class="tab-pane">
                <div class="pane-header-xp">
                  <div>
                ...
                <div class="xp-card">
                  ...
                  <div class="xp-card-body">
                    <form @submit.prevent="createMusicTrack" class="xp-grid-form" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)) 150px; gap: 15px;">
                      <div class="input-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="file" id="music-audio-input" accept="audio/mp3,audio/*" @change="handleAudioUpload" required style="width: 100%;" />
                      ...
                      <div class="input-group">
                        ...
                        <input type="file" id="music-cover-input" accept="image/*" @change="handleCoverUpload" style="width: 100%;" />
                      ...
                      <tr v-for="track in musicTracks" :key="track.id">
                        ...
                        <td>
                          <div style="display: flex; gap: 8px;">
                            <button 
                              v-if="!track.isActive" 
                              @click="activateMusicTrack(track.id)" 
                            ...
                            <button 
                              @click="deleteMusicTrack(track.id)" 
